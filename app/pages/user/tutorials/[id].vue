...
<template>
  <UDashboardPanel id="watch-tutorial">
    ...
    <div class="p-6">
      ...
      <div v-else-if="tutorialsStore.currentTutorial" class="space-y-4">
        <h1 class="text-2xl font-bold">{{ tutorialsStore.currentTutorial.title }}</h1>
        <p v-if="tutorialsStore.currentTutorial.description" class="text-gray-600 dark:text-gray-400">
          {{ tutorialsStore.currentTutorial.description }}
        </p>
        <div v-if="tutorialsStore.currentTutorial.duration" class="text-sm text-gray-600 dark:text-gray-400">
