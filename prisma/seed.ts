				...
				create: [
					{
						...
						imgPath: '',
						comment: 'Red means stop',
						options: {
							create: [
								{ answer: 'Stop', isCorrect: true },
								{ answer: 'Go', isCorrect: false },
								{ answer: 'Caution', isCorrect: false }
							]
						}
					},
					{
						title: 'What does a green traffic light mean?',
						imgPath: '',
